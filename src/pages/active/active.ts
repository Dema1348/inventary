...
export class ActivePage {
  ...
  constructor(private formBuilder: FormBuilder, public navCtrl: NavController,public params: NavParams, public view: ViewController,  public scannerService: ScannerProvider, public cameraService: CameraProvider,public dataService: DataProvider,public autoComplete: AutoCompleteProvider ) {
  ...
  addPhoto(){
    this.cameraService.take().then((imageData)=>{
        this.form.controls['imagen'].setValue('data:image/jpeg;base64,' + imageData);
